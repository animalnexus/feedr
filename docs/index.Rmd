...
1. [__Loading/Importing Data__](#load)  
    Raw data directly from the loggers, already almagamated, or from the animal__nexus__ website 
...
In the normal order of operarations, several functions depend on the output of other functions.
...
- __map_leaflet():__ Visualize movements and/or prsence with leaflet (interactive)
