...
> feedrUI package. This documentation now only reflects the basic feedr functions
>
...
load[label = '{Loading/Importing Data | {load_raw()}}']
...
map[label = '{Visualizations | {map_leaflet()}}']
