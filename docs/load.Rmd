...
Alternatively, you can deterime where `load_raw()` gets extra details from by specifying the `details` argument (defaults to `details = 1`).
...
```{r details0, eval = FALSE}
load_raw("./Data/Raw/exp2/Logger_Data.TXT", logger_pattern = "Logger_[0-9]{2}", details = 0, skip = 1)
```

```{r, echo = FALSE}
load_raw("./Data/Raw/exp2/Logger_Data.TXT", logger_pattern = "Logger_[0-9]{2}", details = 0, skip = 1)[1:6,]
```
