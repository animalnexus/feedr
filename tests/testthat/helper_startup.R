...
d_preformat_sep <- c(system.file("extdata", "import tests", "finches_tab.csv", package = "feedr"),
                     system.file("extdata", "import tests", "finches_semicolon.csv", package = "feedr"))

d_preformat_skip <- c(system.file("extdata", "import tests", "finches_skip.csv", package = "feedr"))


d_logger_ymd <- c(system.file("extdata", "import tests", "logger_ymd1.TXT", package = "feedr"))
