...
test_that("disp() returns correct data", {
  ...
  ## Data
  expect_equal(unique(d1$animal_id[1]), factor("0620000514", levels = c("041868D396", "041868D861", "041868FF93", "062000043E", "06200004F8", "0620000514")))
  ...
  expect_equal(d1$species[1], "HOFI")
