...
test_that("scale_area() returns expected values", {
  s <- list(seq(0.1, 1, length.out = 5), 1:5, 11:15, seq(1000, 5000, 1000), 2:6)
  ...
  expect_equal(
    round(scale_area(c(4, 8, 19, 500, 6000, 30000), min = 5), 6),
...
test_that("scale_area(radius) returns expected values", {
  ...
  for (r in s) {
    ...
    expect_equal(
      round(r, 5),
      c(5.00000, 52.67827, 74.33034, 90.96703, 105.00000)
    )
  }

  expect_equal(
    round(scale_area(c(4, 8, 19, 500, 6000, 30000), radius = TRUE, min = 5), 6),
