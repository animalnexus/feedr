...
test_that("map_leaflet() returns summary map", {
  expect_error(map <- map_leaflet(p = presence(visits(finches)),
                                  ...
                                  summary = "sum"), NA)
  expect_is(map, c("leaflet", "htmlwidget"))
  expect_equal_to_reference(map, "leaflet_sum_map.rds")

  expect_error(map <- map_leaflet(p = presence(visits(finches)),
                                  m = move(visits(finches)),
                                  summary = "sum_indiv"), NA)
  expect_is(map, c("leaflet", "htmlwidget"))
  expect_equal_to_reference(map, "leaflet_sum_indiv_map.rds")
  ...
  expect_is(map, c("leaflet", "htmlwidget"))
  expect_equal_to_reference(map, "leaflet_none_map.rds")
})
...
test_that("map_leaflet() returns summary map of individuals", {
  ...
  expect_is(map, c("leaflet", "htmlwidget"))
  expect_equal_to_reference(map, "leaflet_indiv_map.rds")
...
test_that("map_leaflet() scale, pal, title", {
  ...
  expect_is(map, c("leaflet", "htmlwidget"))
  expect_equal_to_reference(map, "leaflet_args_map.rds")
})
