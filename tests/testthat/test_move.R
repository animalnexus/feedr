...
test_that("move() returns expected data", {
  m <- move(visits(finches))
  expect_equal(unique(m$animal_id[1]), factor("041868D396", levels = c("041868D396", "041868D861", "041868FF93", "062000043E", "06200004F8", "0620000514")))
...
test_that("move() handles zero movements and single animal", {
  ...
  expect_equal(m$animal_id[1], factor("062000043E", levels = c("041868D396", "041868D861", "041868FF93", "062000043E", "06200004F8", "0620000514")))
})
