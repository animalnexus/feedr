...
test_that("load_raw loads and formats data correctly - feeder id from file name", {
  ...
  expect_equal(r$bird_id[2], "062000014F")
  expect_equal(r$feeder_id[2], "GR10")
  expect_equal(r$time[2], as.POSIXct("2016-01-11 12:00:54", tz = "America/Vancouver"))
  expect_equal(load_raw(f, tz_disp = "America/Toronto")$time[2], as.POSIXct("2016-01-11 15:00:54", tz = "America/Toronto"))
})
...
test_that("load_raw loads and formats data correctly - feeder id from first line", {
  ...
  expect_equal(r$feeder_id[2], "GR10")
  expect_equal(r$time[2], as.POSIXct("2016-01-11 12:00:54", tz = "America/Vancouver"))
  expect_equal(load_raw(f, feeder_id_loc = "firstline", tz_disp = "America/Toronto")$time[2], as.POSIXct("2016-01-11 15:00:54", tz = "America/Toronto"))
})
