...
test_that("check_ids catches and removes correctly", {
  ...
  expect_message(check_ids(finches, b), "All ids in your data are also in your animal_id index")
  expect_message(check_ids(finches, b), "All ids in your animal_id index are also in your data")
  ...
  expect_message(check_ids(finches, b), "All ids in your data are also in your animal_id index")
  expect_message(check_ids(finches, b), "All ids in your animal_id index are also in your data")
  expect_message(check_ids(finches, b), "The following animal ids have been omitted: 0620000514, 041868D861")
  ...
  b <- b[b$animal_id != "0620000514",]
  expect_message(check_ids(finches, b), "Some ids present in your data do not exist in the animal_id index: 0620000514")

  r <- finches[!(finches$animal_id %in% c("0620000514", "06200004F8")),]
  expect_message(check_ids(r, b), "Some ids present in your animal_id index, are not in your data: 06200004F8")
