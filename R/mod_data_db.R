    ...
    fluidRow(
      column(4,
             ...
             div(id = "selection",
                 ...
                 bsTooltip(ns("data_site_name"), "Site to grab data from",
                           "right", options = list(container = "body")),
                 uiOutput(ns("UI_data_species")),
                 bsTooltip(ns("UI_data_species"), "Species(s) to include/exclude",
                           "right", options = list(container = "body")),
                 uiOutput(ns("UI_data_date")),
                 bsTooltip(ns("data_weather"), "Should weather data be added from Environment Canada?",
                           "right", options = list(container = "body")),
                 hr(),
                 h3("Selected Data"),
